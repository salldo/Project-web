...
<head>
    ...
    <link href="{{asset('seo-agency-website-template/lib/owlcarousel/assets/owl.carousel.min.css')}}" rel="stylesheet">
        ...
        <div class="container-xxl position-relative p-0">
            <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
                <a href="" class="navbar-brand p-0">
                    <h1 class="m-0"><i class="fa fa-search me-2"></i>BookShelf<span class="fs-5"></span></h1>
                ...
                <div class="container my-5 py-5 px-lg-5">
                    <div class="row g-5 py-5">
                        <div class="col-lg-6 text-center text-lg-start">
                            ...
                            <a href="/login" class="btn btn-light py-sm-3 px-sm-5 rounded-pill me-3 animated slideInLeft">Login</a>
                            <a href="/register" class="btn btn-outline-light py-sm-3 px-sm-5 rounded-pill animated slideInRight">Register</a>
                        </div>
                        <div class="col-lg-6 text-center text-lg-start">
